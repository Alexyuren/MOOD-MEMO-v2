  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={`
          absolute top-6 right-6 z-[100] flex items-center justify-center md:justify-start gap-2 p-2 md:px-4 md:py-2 rounded-full 
      ...
      >
        {isConfirmingClear ? <AlertCircle size={16} /> : <Trash2 size={16} />}
        <span className="font-industrial text-[10px] font-bold tracking-widest text-inherit hidden md:inline">
